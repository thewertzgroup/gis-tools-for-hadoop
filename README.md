...
<a href="https://github.com/wavded/ogre/wiki/Compiling-a-recent-ogr2ogr-from-source-on-CentOS-(RHEL)" target="_blank">Compiling a recent ogr2ogr from source on CentOS (RHEL)</a>
